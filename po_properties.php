     ...
     <div class="usersStats">
      ...
      <table>
       <thead>
        ...
        <?php echo "<td><a href='property_delete.php?id=".$accepted_property['property_id']."&name=".$accepted_property['property_name']."'><ion-icon name=\"trash-outline\"></ion-icon></a><a href='edit_property.php?id=".$accepted_property['property_id']."&name=".$accepted_property['property_name']."''><ion-icon name=\"create-outline\"></ion-icon></a></td>";?>  
